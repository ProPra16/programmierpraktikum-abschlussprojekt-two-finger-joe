...
public class Logic {
	...
	public void Green(Befehl befehl, 
			...
			if(befehl==Befehl.DoRefactoring && getBabyBoolean()==true && (CompileErrors==true || TestFehlschlag == true)){ 
				/*Delete(BabyGreen)*/ System.out.println(" - Delete Code - Refactoring not possible");
...
//BabySteps * * * * * * * * * * * * * * * *     
	...
	{ 
		...
		if((getStatus()==Status.Green) && 
					(CompileErrors()==true || TestFehlschlag()==true)){ /*Delete(BabyGreen)*/ System.out.println(" - Delete Code"); setStatus(Status.Red); return;} //Änderung
		...
		if( (getStatus()==Status.Red) && 
				(CompileErrors()==false && TestFehlschlag()==false)){/*Delete(BabyRed)*/ System.out.println(" - Delete Test"); setStatus(Status.Green); return;} //Änderung
